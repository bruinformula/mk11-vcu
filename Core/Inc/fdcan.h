...
#define VCU_COOLING_CMD_TX_ID 0x090 // UPDATE THIS IF DIFFERENT

// RX ID's
#define BMS_PRCHG_RX_ID 0x6B4
#define INVERTER_VOLTAGE_RX_ID 0x0A7
#define INVERTER_RPM_RX_ID 0x0A5
#define BMS_TEMP_RX_ID 0x6B5 // UPDATE THIS IF DIFFERENT
#define INVERTER_TEMP_RX_ID 0x0A2 // UPDATE THIS IF DIFFERENT
