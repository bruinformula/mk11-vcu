...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
volatile uint32_t fdcan1_irq_count =
    0; /* Counter to verify if FDCAN1 interrupt fires */
/* USER CODE END PV */
